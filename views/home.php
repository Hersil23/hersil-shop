...
$featuredProducts = array_slice($productModel->getAll(), 0, 8); // Primeros 8 productos
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="w-full md:w-1/2 text-center md:text-left">
                ...
                <!-- Botones CTA - Stack en móvil, inline en desktop -->
...
<!-- Categorías Destacadas - Mobile First -->
...
<section class="py-12 md:py-16">
    <div class="container mx-auto px-4">
        ...
        <!-- Grid responsive: 2 cols en móvil, 3 en tablet, 4 en desktop -->
...
<!-- Productos Destacados - Mobile First -->
            ...
            <div class="h-48 md:h-56 bg-slate-200 dark:bg-slate-700 overflow-hidden">
                ...
                <?php endif; ?>
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <button class="w-full bg-blue-800 hover:bg-blue-900 text-white px-4 py-2 md:py-3 rounded-lg transition-colors font-semibold text-sm md:text-base">
